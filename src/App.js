...
function Fact({fact, setFacts}){
  ...
  <div className="vote-buttons">
      <button onClick={(() => handlingVote("votesInteresting"))} disabled={isUpdating}
      >🤞 
      {fact.votesInteresting}
      </button >
      <button onClick={(() => handlingVote("votesMindblowing"))} disabled={isUpdating}
      >🤯 
      {fact.votesMindblowing}
      </button>
      <button onClick={(() => handlingVote("votesFalse"))} disabled={isUpdating}
      >📛 
      {fact.votesFalse}
      </button>
  </div>
